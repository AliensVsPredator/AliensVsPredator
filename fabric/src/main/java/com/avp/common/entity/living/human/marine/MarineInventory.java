...
public class MarineInventory implements AVPInventory, InventoryCarrier {
    ...
    public void forEach(Consumer<ItemStack> consumer) {
        personalInventory.items.forEach(consumer);
        primaryInventory.items.forEach(consumer);
    }
    ...
    public Stream<ItemStack> stream() {
        return Stream.concat(personalInventory.items.stream(), primaryInventory.items.stream());
    }
