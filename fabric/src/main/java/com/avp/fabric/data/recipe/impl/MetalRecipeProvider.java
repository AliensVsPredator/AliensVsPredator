...
public class MetalRecipeProvider {
    ...
    private static void createSmeltAndBlastRecipes(RecipeBuilder builder, Supplier<? extends ItemLike> inputSupplier, Supplier<? extends ItemLike> outputSupplier) {
        builder.smelt(inputSupplier)
            .withCategory(RecipeCategory.MISC)
            .withExperience(RecipeConstants.RARE_SMELT_EXPERIENCE)
            .into(outputSupplier);

        builder.blast(inputSupplier)
            .withCategory(RecipeCategory.MISC)
            .withExperience(RecipeConstants.RARE_SMELT_EXPERIENCE)
            .into(outputSupplier);
    }
