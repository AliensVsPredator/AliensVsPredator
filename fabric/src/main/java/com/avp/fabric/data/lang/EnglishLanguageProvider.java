...
public class EnglishLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder builder) {
        ...
        builder.add(AVPItems.ALIEN_MUSIC_DISC_1_FRAGMENT.get().getDescriptionId() + ".desc", "Music Disc - Silver Smile");
        ...
        addItem(builder, AVPItems.CHITIN, "Chitin");
        ...
        addItem(builder, AVPItems.PLATED_CHITIN, "Plated Chitin");
        addItem(builder, AVPItems.PLATED_NETHER_CHITIN, "Plated Nether Chitin");
        ...
        addItem(builder, AVPItems.RESIN_BALL, "Resin Ball");
        ...
        addItem(builder, AVPItems.IRRADIATED_RESIN_BALL, "Irradiated Resin Ball");
        addItem(builder, AVPItems.IRRADIATED_CHITIN, "Irradiated Chitin");
        addItem(builder, AVPItems.PLATED_IRRADIATED_CHITIN, "Plated Irradiated Chitin");
