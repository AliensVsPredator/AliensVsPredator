...
public class ResinRecipeProvider {
    ...
    private static void createResinRecipes(RecipeBuilder builder) {
        ...
        RecipeUtil.createCompressedBlockRecipes2x2(builder, TempAVPItems.ABERRANT_RESIN_BALL.get(), TempAVPBlocks.ABERRANT_RESIN.get());
        ...
        RecipeUtil.createCompressedBlockRecipes2x2(builder, TempAVPItems.NETHER_RESIN_BALL.get(), TempAVPBlocks.NETHER_RESIN.get());
