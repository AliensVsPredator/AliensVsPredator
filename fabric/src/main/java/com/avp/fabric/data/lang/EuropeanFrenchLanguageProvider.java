...
import com.avp.fabric.data.AVPDataGenerator;

/**
 * TODO: Making this for any PRs, this will just need registered in {@link AVPDataGenerator#onInitializeDataGenerator}
 */
public class EuropeanFrenchLanguageProvider extends FabricLanguageProvider {

    public EuropeanFrenchLanguageProvider(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
