...
public class BlockLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        AVPBlocks.DYE_COLOR_TO_PADDING_SLAB.values().forEach(blockSupplier -> add(blockSupplier, createSlabItemTable(blockSupplier)));
        ...
        AVPBlocks.DYE_COLOR_TO_PANEL_PADDING_SLAB.values().forEach(blockSupplier -> add(blockSupplier, createSlabItemTable(blockSupplier)));
        ...
        AVPBlocks.DYE_COLOR_TO_PIPE_PADDING_SLAB.values().forEach(blockSupplier -> add(blockSupplier, createSlabItemTable(blockSupplier)));
        ...
        AVPBlocks.DYE_COLOR_TO_CUT_PLASTIC_SLAB.values().forEach(blockSupplier -> add(blockSupplier, createSlabItemTable(blockSupplier)));
        ...
        AVPBlocks.DYE_COLOR_TO_PLASTIC_SLAB.values().forEach(blockSupplier -> add(blockSupplier, createSlabItemTable(blockSupplier)));
    ...
    private void add(Supplier<Block> blockSupplier, Function<Block, LootTable.Builder> factory) {
        add(blockSupplier.get(), factory);
    }

    private void add(Supplier<Block> blockSupplier, LootTable.Builder builder) {
        add(blockSupplier.get(), builder);
    }

    private LootTable.Builder createSlabItemTable(Supplier<Block> blockSupplier) {
        return createSlabItemTable(blockSupplier.get());
    }

    private void dropOther(Supplier<? extends Block> blockSupplier, Supplier<? extends ItemLike> otherSupplier) {
        dropOther(blockSupplier.get(), otherSupplier.get());
    }
