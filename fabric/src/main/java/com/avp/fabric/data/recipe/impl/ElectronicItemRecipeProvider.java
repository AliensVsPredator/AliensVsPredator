...
public class ElectronicItemRecipeProvider {
    ...
    private static void createElectronicItemRecipes(RecipeBuilder builder) {
        ...
        builder.shaped()
            ...
            .define('B', CommonConstants.DUSTS_REDSTONE)
            .define('C', CommonConstants.SILICON)
            .pattern("AB")
            .pattern(" C")
            .pattern("AB")
        ...
        builder.shaped()
            ...
            .define('R', CommonConstants.DUSTS_REDSTONE)
            .define('S', CommonConstants.SILICON)
        ...
        builder.shaped()
            ...
            .define('O', CommonConstants.DUSTS_REDSTONE)
            .define('R', AVPItems.RESISTOR)
            .define('S', CommonConstants.SILICON)
