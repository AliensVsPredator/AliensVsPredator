...
import static org.avp.api.common.config.ConfigConstants.COMMENT;
import static org.avp.api.common.config.ConfigConstants.DEFAULT;
import static org.avp.api.common.config.ConfigConstants.EQUALS;
import static org.avp.api.common.config.ConfigConstants.INTERNAL_COMMENT;
import static org.avp.api.common.config.ConfigConstants.INTERNAL_COMMENT_SEPARATOR;
import static org.avp.api.common.config.ConfigConstants.MAX;
import static org.avp.api.common.config.ConfigConstants.MIN;
import static org.avp.api.common.config.ConfigConstants.NEW_LINE;
import static org.avp.api.common.config.ConfigConstants.NEW_LINE_REGEX;
import static org.avp.api.common.config.ConfigConstants.VALID_TYPES;
...
public record ConfigField(
    ...
    public static Optional<ConfigField> create(@Nullable ConfigCategory configCategory, Field field) {
        ...
        if (!VALID_TYPES.contains(type)) {
            LOGGER.warn("The config '{}' value type {} is not supported!", field.getName(), type.getName());
            return Optional.empty();
        }
    ...
    public static List<ConfigField> getAllFromType(Class<?> configClass) {
        LOGGER.debug("Getting config fields from class {}", configClass.getName());
        ...
        LOGGER.debug("Got {} configs", configs.size());
        return configs;
    }
