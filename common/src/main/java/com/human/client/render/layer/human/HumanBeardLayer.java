...
public class HumanBeardLayer<T extends AbstractHuman> implements AzRenderLayer<UUID, T> {
    ...
    public void render(AzRendererPipelineContext<UUID, T> context) {
        ...
        var textureLocation = animatable.getHumanFeatureManager().getBeardTextureOrNull();
        HumanRenderLayerUtil.applyColorWithInvisibility(context, textureLocation, animatable.hairColor.get());
    }
