...
public class AVPEntityTransitions {
    ...
    public static <T extends Entity> @Nullable T transitionInto(Entity oldEntity, EntityType<T> newEntityType) {
        return transitionInto(oldEntity, newEntityType, DEFAULT_NBT_KEY_BLACKLIST);
    }

    public static <T extends Entity> @Nullable T transitionInto(
        Entity oldEntity,
