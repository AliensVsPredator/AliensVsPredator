...
import com.avp.common.constant.ArmorToughnessConstants;
...
import com.avp.common.constant.HealthRegenConstants;
import com.avp.common.constant.KnockbackResistanceConstants;
...
public class AVPConfig {
    ...
    public static class StatsConfigs {
        ...
        @Configurable.Synchronized
        @Configurable.Comment("Modifying any of these will require restarting the game.")
        public AdvancedStats PREDALIEN_ADOLESCENT_STATS = new AdvancedStats(
            HealthConstants.PREDALIEN_ADOLESCENT_HEALTH,
            AttackDamageConstants.PREDALIEN_ADOLESCENT_ATTACK_DAMAGE,
            HealthRegenConstants.PREDALIEN_ADOLESCENT_HEALTH_REGEN,
            KnockbackResistanceConstants.PREDALIEN_ADOLESCENT_KNOCKBACK_RESISTANCE,
            MoveSpeedConstants.PREDALIEN_ADOLESCENT_SPEED,
            0.0F,
            0.0f,
            750,
            FollowRangeConstants.PREDALIEN_ADOLESCENT_FOLLOW_RANGE
        );

        @Configurable
        @Configurable.Synchronized
        @Configurable.Comment("Modifying any of these will require restarting the game.")
        public AdvancedStats PREDALIEN_CHESTBURSTER_STATS = new AdvancedStats(
            HealthConstants.PREDALIEN_CHESTBURSTER_HEALTH,
            AttackDamageConstants.PREDALIEN_CHESTBURSTER_ATTACK_DAMAGE,
            HealthRegenConstants.PREDALIEN_CHESTBURSTER_HEALTH_REGEN,
            KnockbackResistanceConstants.PREDALIEN_CHESTBURSTER_KNOCKBACK_RESISTANCE,
            MoveSpeedConstants.PREDALIEN_CHESTBURSTER_SPEED,
            0.0F,
            0.0f,
            750,
            FollowRangeConstants.PREDALIEN_CHESTBURSTER_FOLLOW_RANGE
        );
