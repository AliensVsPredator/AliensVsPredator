...
public class TempAVPItems {
    ...
    private static AVPDeferredHolder<Item> register(String name, Item.Properties properties) {
        return register(name, () -> new Item(properties));
    }

    private static AVPDeferredHolder<Item> register(String name, Supplier<Item> itemSupplier) {
