...
public class TempAVPBlockItems {
    ...
    public static final AVPDeferredHolder<BlockItem> ALUMINUM_BLOCK = register("aluminum_block", TempAVPBlocks.ALUMINUM_BLOCK);

    public static final AVPDeferredHolder<BlockItem> AMMO_CHEST = registerDirect("ammo_chest", AmmoChestBlockItem::new);

    public static final AVPDeferredHolder<BlockItem> ASH_BLOCK = register("ash_block", TempAVPBlocks.ASH_BLOCK);

    public static final AVPDeferredHolder<BlockItem> AUTUNITE_BLOCK = register("autunite_block", TempAVPBlocks.AUTUNITE_BLOCK);

    public static final AVPDeferredHolder<BlockItem> AUTUNITE_ORE = register("autunite_ore", TempAVPBlocks.AUTUNITE_ORE);

    public static final AVPDeferredHolder<BlockItem> BAUXITE_ORE = register("bauxite_ore", TempAVPBlocks.BAUXITE_ORE);

    public static final AVPDeferredHolder<BlockItem> BLUEPRINT_BLOCK = register("blueprint_block", TempAVPBlocks.BLUEPRINT_BLOCK);

    public static final AVPDeferredHolder<BlockItem> BRASS_BLOCK = register("brass_block", TempAVPBlocks.BRASS_BLOCK);
    ...
    public static final AVPDeferredHolder<BlockItem> CHISELED_STEEL = register("chiseled_steel", TempAVPBlocks.CHISELED_STEEL);

    public static final AVPDeferredHolder<BlockItem> CHISELED_TITANIUM = register("chiseled_titanium", TempAVPBlocks.CHISELED_TITANIUM);

    public static final AVPDeferredHolder<BlockItem> CUT_FERROALUMINUM = register("cut_ferroaluminum", TempAVPBlocks.CUT_FERROALUMINUM);
    ...
    public static final AVPDeferredHolder<BlockItem> CUT_STEEL = register("cut_steel", TempAVPBlocks.CUT_STEEL);

    public static final AVPDeferredHolder<BlockItem> CUT_STEEL_SLAB = register("cut_steel_slab", TempAVPBlocks.CUT_STEEL_SLAB);

    public static final AVPDeferredHolder<BlockItem> CUT_STEEL_STAIRS = register("cut_steel_stairs", TempAVPBlocks.CUT_STEEL_STAIRS);

    public static final AVPDeferredHolder<BlockItem> CUT_TITANIUM = register("cut_titanium", TempAVPBlocks.CUT_TITANIUM);

    public static final AVPDeferredHolder<BlockItem> CUT_TITANIUM_SLAB = register("cut_titanium_slab", TempAVPBlocks.CUT_TITANIUM_SLAB);

    public static final AVPDeferredHolder<BlockItem> CUT_TITANIUM_STAIRS = register(
        "cut_titanium_stairs",
        TempAVPBlocks.CUT_TITANIUM_STAIRS
    );
    ...
    public static final AVPDeferredHolder<BlockItem> DEEPSLATE_ZINC_ORE = register("deepslate_zinc_ore", TempAVPBlocks.DEEPSLATE_ZINC_ORE);

    public static final AVPDeferredHolder<BlockItem> DESK_TERMINAL_BLOCK = register("desk_terminal", TempAVPBlocks.DESK_TERMINAL_BLOCK);

    public static final AVPDeferredHolder<BlockItem> FERROALUMINUM_BLOCK = register(
        "ferroaluminum_block",
        TempAVPBlocks.FERROALUMINUM_BLOCK
    );

    public static final AVPDeferredHolder<BlockItem> FERROALUMINUM_BUTTON = register(
        "ferroaluminum_button",
        TempAVPBlocks.FERROALUMINUM_BUTTON
    );
    ...
    public static final AVPDeferredHolder<BlockItem> FERROALUMINUM_COLUMN = register(
        ...
        TempAVPBlocks.FERROALUMINUM_COLUMN
    );

    public static final AVPDeferredHolder<BlockItem> FERROALUMINUM_DOOR = register("ferroaluminum_door", TempAVPBlocks.FERROALUMINUM_DOOR);
    ...
    public static final AVPDeferredHolder<BlockItem> FERROALUMINUM_SLAB = register("ferroaluminum_slab", TempAVPBlocks.FERROALUMINUM_SLAB);

    public static final AVPDeferredHolder<BlockItem> FERROALUMINUM_STAIRS = register(
        "ferroaluminum_stairs",
        TempAVPBlocks.FERROALUMINUM_STAIRS
    );
    ...
    public static final AVPDeferredHolder<BlockItem> GALENA_ORE = register("galena_ore", TempAVPBlocks.GALENA_ORE);
    ...
    public static final AVPDeferredHolder<BlockItem> IRRADIATED_RESIN = register("irradiated_resin", TempAVPBlocks.IRRADIATED_RESIN);

    public static final AVPDeferredHolder<BlockItem> IRRADIATED_RESIN_NODE = register(
        "irradiated_resin_node",
        TempAVPBlocks.IRRADIATED_RESIN_NODE
    );
    ...
    public static final AVPDeferredHolder<BlockItem> IRRADIATED_RESIN_WEB = register(
        ...
        TempAVPBlocks.IRRADIATED_RESIN_WEB
    );

    public static final AVPDeferredHolder<BlockItem> LEAD_BLOCK = register("lead_block", TempAVPBlocks.LEAD_BLOCK);

    public static final AVPDeferredHolder<BlockItem> LEAD_CHEST = registerDirect("lead_chest", LeadChestBlockItem::new);

    public static final AVPDeferredHolder<BlockItem> LITHIUM_BLOCK = register("lithium_block", TempAVPBlocks.LITHIUM_BLOCK);

    public static final AVPDeferredHolder<BlockItem> LITHIUM_ORE = register("lithium_ore", TempAVPBlocks.LITHIUM_ORE);

    public static final AVPDeferredHolder<BlockItem> MONAZITE_ORE = register("monazite_ore", TempAVPBlocks.MONAZITE_ORE);
    ...
    public static final AVPDeferredHolder<BlockItem> RAW_MONAZITE_BLOCK = register("raw_monazite_block", TempAVPBlocks.RAW_MONAZITE_BLOCK);

    public static final AVPDeferredHolder<BlockItem> RAW_SILICA_BLOCK = register("raw_silica_block", TempAVPBlocks.RAW_SILICA_BLOCK);

    public static final AVPDeferredHolder<BlockItem> RAW_TITANIUM_BLOCK = register("raw_titanium_block", TempAVPBlocks.RAW_TITANIUM_BLOCK);
    ...
    public static final AVPDeferredHolder<BlockItem> RESIN_BRICKS = register("resin_bricks", TempAVPBlocks.RESIN_BRICKS);

    public static final AVPDeferredHolder<BlockItem> RESIN_NODE = register("resin_node", TempAVPBlocks.RESIN_NODE);

    public static final AVPDeferredHolder<BlockItem> RESIN_O = register("resin_o", TempAVPBlocks.RESIN_O);

    public static final AVPDeferredHolder<BlockItem> RESIN_RIBBED = register("resin_ribbed", TempAVPBlocks.RESIN_RIBBED);

    public static final AVPDeferredHolder<BlockItem> RESIN_SMOOTH = register("resin_smooth", TempAVPBlocks.RESIN_SMOOTH);

    public static final AVPDeferredHolder<BlockItem> RESIN_VEIN = register("resin_vein", TempAVPBlocks.RESIN_VEIN);

    public static final AVPDeferredHolder<BlockItem> RESIN_WEB = register("resin_web", TempAVPBlocks.RESIN_WEB);

    public static final AVPDeferredHolder<BlockItem> RESONATOR_BLOCK = register("resonator", TempAVPBlocks.RESONATOR_BLOCK);
    ...
    public static final AVPDeferredHolder<BlockItem> SILICA_GRAVEL = register("silica_gravel", TempAVPBlocks.SILICA_GRAVEL);

    public static final AVPDeferredHolder<BlockItem> STEEL_BARS = register("steel_bars", TempAVPBlocks.STEEL_BARS);

    public static final AVPDeferredHolder<BlockItem> STEEL_BLOCK = register("steel_block", TempAVPBlocks.STEEL_BLOCK);

    public static final AVPDeferredHolder<BlockItem> STEEL_BUTTON = register("steel_button", TempAVPBlocks.STEEL_BUTTON);

    public static final AVPDeferredHolder<BlockItem> STEEL_CHAIN_FENCE = register("steel_chain_fence", TempAVPBlocks.STEEL_CHAIN_FENCE);

    public static final AVPDeferredHolder<BlockItem> STEEL_COLUMN = register("steel_column", TempAVPBlocks.STEEL_COLUMN);

    public static final AVPDeferredHolder<BlockItem> STEEL_DOOR = register("steel_door", TempAVPBlocks.STEEL_DOOR);
    ...
    public static final AVPDeferredHolder<BlockItem> STEEL_GRATE = register("steel_grate", TempAVPBlocks.STEEL_GRATE);

    public static final AVPDeferredHolder<BlockItem> STEEL_GRATE_SLAB = register("steel_grate_slab", TempAVPBlocks.STEEL_GRATE_SLAB);

    public static final AVPDeferredHolder<BlockItem> STEEL_GRATE_STAIRS = register("steel_grate_stairs", TempAVPBlocks.STEEL_GRATE_STAIRS);

    public static final AVPDeferredHolder<BlockItem> STEEL_PLATING = register("steel_plating", TempAVPBlocks.STEEL_PLATING);

    public static final AVPDeferredHolder<BlockItem> STEEL_PLATING_SLAB = register("steel_plating_slab", TempAVPBlocks.STEEL_PLATING_SLAB);
    ...
    public static final AVPDeferredHolder<BlockItem> STEEL_PRESSURE_PLATE = register(
        ...
        TempAVPBlocks.STEEL_PRESSURE_PLATE
    );

    public static final AVPDeferredHolder<BlockItem> STEEL_SIDING = register("steel_siding", TempAVPBlocks.STEEL_SIDING);

    public static final AVPDeferredHolder<BlockItem> STEEL_SIDING_SLAB = register("steel_siding_slab", TempAVPBlocks.STEEL_SIDING_SLAB);
    ...
    public static final AVPDeferredHolder<BlockItem> STEEL_SLAB = register("steel_slab", TempAVPBlocks.STEEL_SLAB);

    public static final AVPDeferredHolder<BlockItem> STEEL_STAIRS = register("steel_stairs", TempAVPBlocks.STEEL_STAIRS);

    public static final AVPDeferredHolder<BlockItem> STEEL_STANDING = register("steel_standing", TempAVPBlocks.STEEL_STANDING);
    ...
    public static final AVPDeferredHolder<BlockItem> STEEL_TRAP_DOOR = register("steel_trapdoor", TempAVPBlocks.STEEL_TRAP_DOOR);

    public static final AVPDeferredHolder<BlockItem> STEEL_TREAD = register("steel_tread", TempAVPBlocks.STEEL_TREAD);

    public static final AVPDeferredHolder<BlockItem> STEEL_TREAD_SLAB = register("steel_tread_slab", TempAVPBlocks.STEEL_TREAD_SLAB);

    public static final AVPDeferredHolder<BlockItem> STEEL_TREAD_STAIRS = register("steel_tread_stairs", TempAVPBlocks.STEEL_TREAD_STAIRS);

    public static final AVPDeferredHolder<BlockItem> TITANIUM_BLOCK = register("titanium_block", TempAVPBlocks.TITANIUM_BLOCK);

    public static final AVPDeferredHolder<BlockItem> TITANIUM_BUTTON = register("titanium_button", TempAVPBlocks.TITANIUM_BUTTON);

    public static final AVPDeferredHolder<BlockItem> TITANIUM_CHAIN_FENCE = register(
        "titanium_chain_fence",
        TempAVPBlocks.TITANIUM_CHAIN_FENCE
    );

    public static final AVPDeferredHolder<BlockItem> TITANIUM_COLUMN = register("titanium_column", TempAVPBlocks.TITANIUM_COLUMN);

    public static final AVPDeferredHolder<BlockItem> TITANIUM_DOOR = register("titanium_door", TempAVPBlocks.TITANIUM_DOOR);
    ...
    public static final AVPDeferredHolder<BlockItem> TITANIUM_GRATE = register("titanium_grate", TempAVPBlocks.TITANIUM_GRATE);
    ...
    public static final AVPDeferredHolder<BlockItem> TITANIUM_PLATING = register("titanium_plating", TempAVPBlocks.TITANIUM_PLATING);
    ...
    public static final AVPDeferredHolder<BlockItem> TITANIUM_SIDING = register("titanium_siding", TempAVPBlocks.TITANIUM_SIDING);
    ...
    public static final AVPDeferredHolder<BlockItem> TITANIUM_SLAB = register("titanium_slab", TempAVPBlocks.TITANIUM_SLAB);

    public static final AVPDeferredHolder<BlockItem> TITANIUM_STAIRS = register("titanium_stairs", TempAVPBlocks.TITANIUM_STAIRS);

    public static final AVPDeferredHolder<BlockItem> TITANIUM_STANDING = register("titanium_standing", TempAVPBlocks.TITANIUM_STANDING);
    ...
    public static final AVPDeferredHolder<BlockItem> TITANIUM_TRAP_DOOR = register("titanium_trapdoor", TempAVPBlocks.TITANIUM_TRAP_DOOR);

    public static final AVPDeferredHolder<BlockItem> TITANIUM_TREAD = register("titanium_tread", TempAVPBlocks.TITANIUM_TREAD);
    ...
    public static final AVPDeferredHolder<BlockItem> TRINITITE_BLOCK = register("trinitite_block", TempAVPBlocks.TRINITITE_BLOCK);

    public static final AVPDeferredHolder<BlockItem> TRIP_MINE_BLOCK = register("trip_mine", TempAVPBlocks.TRIP_MINE_BLOCK);

    public static final AVPDeferredHolder<BlockItem> URANIUM_BLOCK = register("uranium_block", TempAVPBlocks.URANIUM_BLOCK);

    public static final AVPDeferredHolder<BlockItem> ZINC_BLOCK = register("zinc_block", TempAVPBlocks.ZINC_BLOCK);

    public static final AVPDeferredHolder<BlockItem> ZINC_ORE = register("zinc_ore", TempAVPBlocks.ZINC_ORE);
