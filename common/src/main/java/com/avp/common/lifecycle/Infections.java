...
public class Infections {
    ...
    // );
    //
    // public static final Infection<Facehugger, Chestburster> ABERRANT_FACEHUGGER_PRODUCES_ABERRANT_CHESTBURSTER =
    // register(
    // createFacehuggerInfection(AVPEntityTypes.ABERRANT_FACEHUGGER, AVPEntityTypes.ABERRANT_CHESTBURSTER)
    // );
    //
    // public static final Infection<Facehugger, Chestburster> NETHER_FACEHUGGER_PRODUCES_NETHER_CHESTBURSTER =
    // register(
    ...
    // );
    //
    // public static final Infection<Facehugger, Chestburster>
    // ROYAL_ABERRANT_FACEHUGGER_PRODUCES_ROYAL_ABERRANT_CHESTBURSTER = register(
    // createFacehuggerInfection(AVPEntityTypes.ROYAL_ABERRANT_FACEHUGGER, AVPEntityTypes.ROYAL_ABERRANT_CHESTBURSTER)
    // );
    //
    // public static final Infection<Facehugger, Chestburster>
    // ROYAL_NETHER_FACEHUGGER_PRODUCES_ROYAL_NETHER_CHESTBURSTER = register(
