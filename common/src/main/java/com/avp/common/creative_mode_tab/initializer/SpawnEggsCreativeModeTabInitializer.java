...
public class SpawnEggsCreativeModeTabInitializer {
    ...
    public static final Consumer<CreativeModeTab.Output> OUTPUT_CONSUMER = output -> {
        ...
        CreativeModeTabUtil.accept(output, AVPSpawnEggItems.OVAMORPH_SPAWN_EGG);
        ...
        CreativeModeTabUtil.accept(output, AVPSpawnEggItems.NETHER_OVAMORPH_SPAWN_EGG);
        ...
        CreativeModeTabUtil.accept(output, AVPSpawnEggItems.ABERRANT_OVAMORPH_SPAWN_EGG);
        ...
        CreativeModeTabUtil.accept(output, AVPSpawnEggItems.ROYAL_OVAMORPH_SPAWN_EGG);
        ...
        CreativeModeTabUtil.accept(output, AVPSpawnEggItems.ROYAL_NETHER_OVAMORPH_SPAWN_EGG);
        ...
        CreativeModeTabUtil.accept(output, AVPSpawnEggItems.ROYAL_ABERRANT_OVAMORPH_SPAWN_EGG);
