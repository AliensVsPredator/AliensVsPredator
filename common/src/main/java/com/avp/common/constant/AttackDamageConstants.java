...
public record AttackDamageConstants() {
    ...
    public static final float PREDALIEN_ADOLESCENT_ATTACK_DAMAGE = PLAYER_HEALTH * 0.1F;

    public static final float PREDALIEN_ATTACK_DAMAGE = PLAYER_HEALTH * 0.75F;

    public static final float PREDALIEN_CHESTBURSTER_ATTACK_DAMAGE = PLAYER_HEALTH * 0.1F;
    ...
    public static final float SPITTER_ATTACK_DAMAGE = PLAYER_HEALTH * 0.5F;
