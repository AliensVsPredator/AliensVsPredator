...
public class AVPSoundEvents {
    ...
    public static final Supplier<SoundEvent> BLOCK_RESIN_SPREAD = register("block.resin.spread");

    public static final Supplier<SoundEvent> ENTITY_OVAMORPH_HATCH = register("entity.ovamorph.hatch");

    public static final Supplier<SoundEvent> ENTITY_OVAMORPH_LAID = register("entity.ovamorph.laid");

    public static final Supplier<SoundEvent> ENTITY_OVAMORPH_ROOT = register("entity.ovamorph.root");

    public static final Supplier<SoundEvent> ENTITY_OVAMORPH_SHEAR = register("entity.ovamorph.shear");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_ARM_ATTACK = register("entity.queen.arm_attack");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_BACK_HAND_ATTACK = register("entity.queen.back_hand_attack");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_DEATH = register("entity.queen.death");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_HURT = register("entity.queen.hurt");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_IDLE = register("entity.queen.idle");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_RAM_ATTACK = register("entity.queen.ram_attack");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_SCREAM = register("entity.queen.scream");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_STEP_THUMP = register("entity.queen.step_thump");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_STEP_THUMP_ROCK = register("entity.queen.step_thump_rock");

    public static final Supplier<SoundEvent> ENTITY_QUEEN_TAIL_ATTACK = register("entity.queen.tail_attack");
    ...
    public static final Supplier<SoundEvent> WEAPON_M6B_ROCKET_LAUNCHER_RELOAD_FINISH = register(
        "item.weapon.m6b_rocket_launcher.reload_finish"
    );

    public static final Supplier<SoundEvent> WEAPON_M6B_ROCKET_LAUNCHER_RELOAD_START = register(
    ...
    public static final Supplier<SoundEvent> JUKEBOX_SOUNDS_ALIEN_MUSIC_1 = register("jukebox_sounds.alien_music_1");

    public static final Supplier<SoundEvent> JUKEBOX_SOUNDS_PREDATOR_MUSIC_1 = register("jukebox_sounds.predator_music_1");
