...
public class AVPJEIPlugin implements IModPlugin {
	public static final RecipeType<IndustrialFurnaceRecipe> INDUSTRIAL_FURNACE_TYPE = RecipeType.create(AVP.MOD_ID, "smeltery", IndustrialFurnaceRecipe.class);
	...
	public void registerRecipes(@NotNull IRecipeRegistration registration) {
		...
		registration.addRecipes(
			...
			recipeManager.getAllRecipesFor(AVPRecipes.INDUSTRIAL_FURNACE_RECIPE_TYPE.get()).stream()
