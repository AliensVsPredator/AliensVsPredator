...
public class BlueAcidParticle extends TextureSheetParticle {
    ...
    public BlueAcidParticle(ClientLevel clientWorld, double d, double e, double f, double g, double h, double i, SpriteSet spriteProvider) {
