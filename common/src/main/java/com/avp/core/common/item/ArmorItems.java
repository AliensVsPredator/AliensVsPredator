...
public class ArmorItems {
    ...
    public static Supplier<Item> register(String id, Supplier<ArmorMaterial> armorMaterialSupplier, ArmorItem.Type type, int durabilityMultiplier) {
    ...
    public static Supplier<Item> register(
        ...
        return register(() -> new ArmorItem(Holder.direct(armorMaterialSupplier.get()), type, properties), id);
    }
