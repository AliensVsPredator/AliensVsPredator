...
import com.avp.core.common.ai.goal.DigToTargetGoal;
import com.avp.core.common.ai.goal.StrollAroundInWaterGoal;
...
import com.avp.core.common.manager.CrawlingManager;
import com.avp.core.common.manager.GrowthManager;
import com.avp.core.common.manager.VibrationSystemManager;
import com.avp.core.common.sound.AVPSoundEvents;
import com.avp.core.common.util.AlienPredicates;
...
public abstract class Xenomorph extends Alien implements ResinProducer {
    ...
    public void setTarget(@Nullable LivingEntity livingEntity) {
        if (livingEntity != null && !livingEntity.equals(getTarget()) && ambientSoundTime > getAmbientSoundInterval()) {
            playSound(AVPSoundEvents.ENTITY_XENOMORPH_HISS.get(), getSoundVolume(), (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F);
        }
