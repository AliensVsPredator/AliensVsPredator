package com.avp.core.common.level.gameevent.listener;
...
public class ResinSpreadListener implements GameEventListener {
    ...
    @Override
    public boolean handleGameEvent(@NotNull ServerLevel serverLevel, Holder<GameEvent> holder, @NotNull GameEvent.Context context, @NotNull Vec3 vec3) {
        // TODO: Verify this works
        if (!holder.is(Holder.direct(AVPGameEvents.XENOMORPH_RESIN_SPREAD.get()))) {
            return false;
        }
