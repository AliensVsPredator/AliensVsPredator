package com.avp.core.common.entity.living.alien;
...
import com.avp.core.common.config.ConfigPropertyMappings;
...
import com.avp.core.common.manager.HiveManager;
import com.avp.core.common.util.AcidBleedUtil;
import com.avp.core.common.util.AlienHurtUtil;
...
public abstract class Alien extends Monster {
    ...
    protected float getHealthRegenPerSecond() {
        ...
        var container = ConfigPropertyMappings.BY_ENTITY_TYPE.get().get(getType());
