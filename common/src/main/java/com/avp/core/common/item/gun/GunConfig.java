...
public record GunConfig(
    @Nullable Supplier<? extends ItemLike> ammunitionItemSupplier,
    int durability,
    ...
    public static class Builder {
        ...
        private Supplier<? extends ItemLike> ammunitionItemSupplier;
        ...
        public Builder withAmmunitionItemSupplier(Supplier<? extends ItemLike> ammunitionItemSupplier) {
