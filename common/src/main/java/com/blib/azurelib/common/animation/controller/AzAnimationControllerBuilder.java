...
/**
 * A builder class to construct {@link com.blib.azurelib.common.animation.controller.AzAnimationController} instances
 * for managing animations in {@link AzAnimator}. This provides a fluent API to configure properties such as animation
 * speed, keyframe callbacks, easing type, transition length, and triggerable animations.
 *
...
public class AzAnimationControllerBuilder<T> {
     ...
     */
    public com.blib.azurelib.common.animation.controller.AzAnimationController<T> build() {
