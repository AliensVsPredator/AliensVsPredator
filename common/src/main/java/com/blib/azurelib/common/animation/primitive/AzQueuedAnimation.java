 ...
 * queued animation to be played, including its associated
 * {@link com.blib.azurelib.common.animation.primitive.AzBakedAnimation} instance and the {@link AzPlayBehavior} that
 ...
 * Fields:
 * <ul>
 * <li>{@code animation}: The {@link com.blib.azurelib.common.animation.primitive.AzBakedAnimation} instance that
 * contains the actual animation data to be played.</li>
