 ...
 * Allows flexible registration of {@link com.blib.azurelib.common.render.armor.AzArmorRenderer} instances to render
 * armor items differently based on their CustomModelData, falling back to vanilla rendering if no custom renderer is
 * registered.
 */
public class AzArmorRendererRegistry {
    ...
    private static final Map<ArmorKey, com.blib.azurelib.common.render.armor.AzArmorRenderer> ITEM_TO_RENDERER = new HashMap<>();

    /** Map storing renderer suppliers for lazy initialization. */
    private static final Map<ArmorKey, Supplier<com.blib.azurelib.common.render.armor.AzArmorRenderer>> ITEM_TO_RENDERER_SUPPLIER =
        new HashMap<>();
     ...
     * @param armorRendererSupplier A supplier providing the
     *                              {@link com.blib.azurelib.common.render.armor.AzArmorRenderer} instance.
     */
    public static void register(Item item, Supplier<com.blib.azurelib.common.render.armor.AzArmorRenderer> armorRendererSupplier) {
    ...
    public static void register(
        Item item,
        int customModelData,
        Supplier<com.blib.azurelib.common.render.armor.AzArmorRenderer> armorRendererSupplier
    ) {
     ...
     * @return The associated {@link com.blib.azurelib.common.render.armor.AzArmorRenderer}, or null if none is found.
     */
    public static @Nullable com.blib.azurelib.common.render.armor.AzArmorRenderer getOrNull(Item item, int customModelData) {
