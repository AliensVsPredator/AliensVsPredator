...
/**
 * A {@link com.blib.azurelib.common.render.layer.AzRenderLayer} responsible for rendering
 * {@link net.minecraft.world.level.block.state.BlockState BlockStates} or {@link net.minecraft.world.item.ItemStack
 * ItemStacks} onto a specified {@link AzRendererPipeline}. This layer handles the rendering of physical elements, such
 * as blocks and items, associated with animation bones.
 */
