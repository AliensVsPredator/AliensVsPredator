...
/**
 * Configures the rendering behavior for custom entities in the game. This extends
 * {@link com.blib.azurelib.common.render.AzRendererConfig}, adding extra functionality specifically for handling entity
 * death rotations.
 *
 * @param <T> the entity type this configuration applies to, extending {@link Entity}
 */
public class AzEntityRendererConfig<T extends Entity> extends com.blib.azurelib.common.render.AzRendererConfig<UUID, T> {
    ...
    private AzEntityRendererConfig(
        ...
        Function<com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>, com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>> preRenderEntry,
        Function<com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>, com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>> renderEntry,
        Function<com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>, com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>> postRenderEntry,
        ...
        BiFunction<com.blib.azurelib.common.render.AzRendererPipeline<UUID, T>, com.blib.azurelib.common.render.AzLayerRenderer<UUID, T>, com.blib.azurelib.common.render.AzModelRenderer<UUID, T>> modelRendererProvider,
        Function<com.blib.azurelib.common.render.AzRendererPipeline<UUID, T>, com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>> pipelineContextFunction,
    ...
    public static class Builder<T extends Entity> extends com.blib.azurelib.common.render.AzRendererConfig.Builder<UUID, T> {
        ...
        public Builder<T> setPipelineContext(
            Function<com.blib.azurelib.common.render.AzRendererPipeline<UUID, T>, com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>> azRendererPipelineAzRendererPipelineContextFunction
        ) {
        ...
        public Builder<T> setPostRenderEntry(
            Function<com.blib.azurelib.common.render.AzRendererPipelineContext<UUID, T>, AzRendererPipelineContext<UUID, T>> preRenderEntry
        ) {
