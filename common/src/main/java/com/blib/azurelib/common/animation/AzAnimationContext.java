...
public class AzAnimationContext<T> {
    ...
    private final com.blib.azurelib.common.animation.AzAnimatorConfig config;

    private final com.blib.azurelib.common.animation.AzAnimationTimer timer;
    ...
    public AzAnimationContext(
        ...
        com.blib.azurelib.common.animation.AzAnimatorConfig config,
        com.blib.azurelib.common.animation.AzAnimationTimer timer
    ) {
     ...
     *
     * @return The {@link com.blib.azurelib.common.animation.AzAnimatorConfig} instance containing the animation
     ...
     *
     * @return The {@link com.blib.azurelib.common.animation.AzAnimationTimer} instance responsible for animation
     *         timing.
     */
