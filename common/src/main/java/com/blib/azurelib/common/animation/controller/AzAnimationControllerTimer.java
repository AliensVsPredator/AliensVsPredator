...
/**
 * A timer utility that integrates directly with an
 * {@link com.blib.azurelib.common.animation.controller.AzAnimationController} to track and adjust tick values for
...
public class AzAnimationControllerTimer<T> {
    ...
    private final com.blib.azurelib.common.animation.controller.AzAnimationController<T> animationController;
