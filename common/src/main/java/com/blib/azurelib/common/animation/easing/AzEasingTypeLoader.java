...
public class AzEasingTypeLoader {
     ...
     */
    public static com.blib.azurelib.common.animation.easing.AzEasingType fromJson(JsonElement json) {
        if (!(json instanceof JsonPrimitive primitive) || !primitive.isString())
            return com.blib.azurelib.common.animation.easing.AzEasingTypes.LINEAR;
     ...
     * @return The relevant {@code EasingType}, or
     *         {@link com.blib.azurelib.common.animation.easing.AzEasingTypes#LINEAR} if none match
     */
