...
public record AzBoneAnimationQueue(
    AzBone bone,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> rotationXQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> rotationYQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> rotationZQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> positionXQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> positionYQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> positionZQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> scaleXQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> scaleYQueue,
    Queue<com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint> scaleZQueue
) {
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#positionXQueue}
     *
    ...
    public void addPosXPoint(
        com.blib.azurelib.common.animation.controller.keyframe.AzKeyframe<?> keyframe,
        double lerpedTick,
        ...
        this.positionXQueue.add(
            new com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint(
                keyframe,
                lerpedTick,
                transitionLength,
                startValue,
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#positionYQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#positionZQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add a new X, Y, and Z position {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to
    ...
    public void addNextPosition(
        ...
        com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint nextXPoint,
        com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint nextYPoint,
        com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint nextZPoint
    ) {
        addPosXPoint(
            keyframe,
            lerpedTick,
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#scaleXQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#scaleYQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#scaleZQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add a new X, Y, and Z scale {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to
     * their respective queues
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#rotationXQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#rotationYQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add a new {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to the
     * {@link AzBoneAnimationQueue#rotationZQueue}
     *
     * @param keyframe         The {@code Nullable} Keyframe relevant to the animation point
     * @param lerpedTick       The lerped time (current tick + partial tick) that the point starts at
     * @param transitionLength The length of the transition (based on the {@link AzAnimationController})
    ...
    /**
     * Add an X, Y, and Z position {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to
     * their respective queues
     *
    ...
    public void addPositions(
        com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint xPoint,
        com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint yPoint,
        com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint zPoint
    ) {
    ...
    /**
     * Add an X, Y, and Z scale {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to their
     * respective queues
     *
    ...
    /**
     * Add an X, Y, and Z rotation {@link com.blib.azurelib.common.animation.controller.keyframe.AzAnimationPoint} to
     * their respective queues
     *
