...
public abstract class AzRendererPipelineContext<K, T> {
    ...
    private final com.blib.azurelib.common.render.AzRendererPipeline<K, T> rendererPipeline;
    ...
    protected AzRendererPipelineContext(com.blib.azurelib.common.render.AzRendererPipeline<K, T> rendererPipeline) {
