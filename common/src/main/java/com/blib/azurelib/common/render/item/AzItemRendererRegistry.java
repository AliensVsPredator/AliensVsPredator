...
public class AzItemRendererRegistry {
    ...
    private static final Map<Item, com.blib.azurelib.common.render.item.AzItemRenderer> ITEM_TO_RENDERER = new HashMap<>();

    private static final Map<Item, Supplier<com.blib.azurelib.common.render.item.AzItemRenderer>> ITEM_TO_RENDERER_SUPPLIER =
        new HashMap<>();

    public static void register(Item item, Supplier<com.blib.azurelib.common.render.item.AzItemRenderer> itemRendererSupplier) {
        ITEM_TO_RENDERER_SUPPLIER.put(item, itemRendererSupplier);
    }

    public static void register(
        Supplier<com.blib.azurelib.common.render.item.AzItemRenderer> itemRendererSupplier,
        Item item,
        Item... items
    ) {
