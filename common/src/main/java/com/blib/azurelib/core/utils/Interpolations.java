...
/**
 * Interpolation methods This class is responsible for doing different kind of interpolations. Cubic interpolation code
 * was from website below, but BauerCam also uses this code.
 *
 * @author mchorse http://paulbourke.net/miscellaneous/interpolation/ https://github.com/daipenger/BauerCam
 */
public class Interpolations {
    ...
    public static float lerpYaw(float a, float b, float position) {
        a = com.blib.azurelib.core.utils.MathHelper.wrapDegrees(a);
        b = com.blib.azurelib.core.utils.MathHelper.wrapDegrees(b);
    ...
    public static double cubicHermiteYaw(float y0, float y1, float y2, float y3, float position) {
        y0 = com.blib.azurelib.core.utils.MathHelper.wrapDegrees(y0);
        y1 = com.blib.azurelib.core.utils.MathHelper.wrapDegrees(y1);
        y2 = com.blib.azurelib.core.utils.MathHelper.wrapDegrees(y2);
        y3 = com.blib.azurelib.core.utils.MathHelper.wrapDegrees(y3);
    ...
    /**
     * Envelope function allows to create simple attack, sustain and release function. This version only goes from 0 to
     * duration with fade in/out being the same
     */
    ...
    /**
     * Envelope function allows to create simple attack, sustain and release function. This advanced version allows you
