 ...
 * to air, removes the record from the {@code PlacedPieceStore}, pushes a {@link com.blib.mod.common.gameplay.jigsaw.PlacementHistory}
 * snapshot so the deletion is itself undoable, and broadcasts an {@code S2CRemovePlacedPiecePayload}.
 */
