package com.blib.common.data.worldgen;
...
public record BLibOreData(
    ...
    public static class Builder {
        ...
        public BLibOreData build() {
            ...
            return new BLibOreData(resourceLocation, configuredFeatureKey, placedFeatureKey, oreConfiguration, modifiers);
        }
    }
}
