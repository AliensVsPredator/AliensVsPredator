...
public record UVFaces(
    ...
    public static JsonDeserializer<UVFaces> deserializer() {
        return (json, type, context) -> {
            ...
            FaceUV north = GsonHelper.getAsObject(
                obj,
                "north",
                null,
                context,
            ...
            FaceUV south = GsonHelper.getAsObject(
                obj,
                "south",
                null,
                context,
            ...
            FaceUV east = GsonHelper.getAsObject(
                obj,
                "east",
                null,
                context,
            ...
            FaceUV west = GsonHelper.getAsObject(
                obj,
                "west",
                null,
                context,
            ...
            FaceUV up = GsonHelper.getAsObject(
                obj,
                "up",
                null,
                context,
            ...
            FaceUV down = GsonHelper.getAsObject(
                obj,
                "down",
                null,
                context,
