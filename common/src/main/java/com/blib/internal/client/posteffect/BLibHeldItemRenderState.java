 ...
 * {@link BLibGbufferUniforms}, and write a special mask category {@code 0.875} for those fragments. The thermal
 * post shader treats that range as "passthrough" — outputs the original scene color rather than the thermal heat
 * gradient — so held items remain readable in IR mode regardless of what they're rendered against.
 *
 * <p>Single-threaded by design (vanilla render thread).
 */
@ApiStatus.Internal
