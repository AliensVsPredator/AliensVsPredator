    ...
    public static final AzEasingType CATMULLROM = AzEasingTypeRegistry.register(
        ...
        new AzEasingType() {
            ...
            public Double2DoubleFunction buildTransformer(Double value) {
                return AzEasingUtil.easeInOut(
                    AzEasingUtil::catmullRom
                );
            }
