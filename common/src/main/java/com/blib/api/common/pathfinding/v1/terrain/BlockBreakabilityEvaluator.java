...
/**
 * Determines whether a solid block can be broken by an entity for pathfinding purposes, and the traversal cost of doing
 * so. Higher cost means the pathfinder only chooses to break the block when no cheaper alternative path exists.
 */
@FunctionalInterface
