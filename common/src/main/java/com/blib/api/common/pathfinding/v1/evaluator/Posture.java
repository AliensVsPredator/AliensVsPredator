...
/**
 * Defines an entity posture for pathfinding. Each posture has different dimensions, allowing the pathfinder to plan
 * paths that switch between postures when beneficial.
 *
