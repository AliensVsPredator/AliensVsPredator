...
/**
 * Global registry of terrain classification caches, keyed by Level and classifier identity.
 * Entities with the same classifier share a cache. Block change events invalidate all
 * caches for the affected level.
 */
public final class TerrainCacheRegistry {
    ...
    /**
     * Gets or creates a classification cache for the given level and classifier.
     * Entities with the same classifier share the same cache.
     */
    ...
    /**
     * Called when a block changes in the level. Invalidates the affected section
     * in all caches for that level.
     */
