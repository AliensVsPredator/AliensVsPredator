...
/**
 * The full dispatch contract for a play action: how to interpret the dispatch ({@link AzDispatchMode}),
 * what to do when blocked by an endless animation ({@link OnBlockedByEndless}), and how to handle
 * same-name-different-properties dispatches ({@link OnPropertiesChanged}).
 */
