 ...
 * (writes go through {@link com.blib.api.client.render.v1.item.BLibGizmoInput#updateDrag} → override map → world render
 * picks it up next frame), so the user sees their world-space item move while the preview stays put.
 * <p>
