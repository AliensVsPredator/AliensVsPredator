...
import com.blib.engine.ui.panel.chrome.ViewportTransportToolbar;
...
public final class ViewportPanel implements Panel {
     ...
     * that {@link com.blib.engine.render.territory.ChunkClaimOverlayRenderer} draws (world min build height + 1).
     * Picking via the first block hit instead — what the previous version did — felt off in paint mode because the
     * hovered chunk would follow whatever block the user happened to be looking at (e.g. a tree branch or a
