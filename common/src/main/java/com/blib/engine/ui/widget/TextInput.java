 ...
 * {@link com.blib.engine.ui.EngineWorkspaceScreen}. Click on the input rect → focus + caret positioned at click x.
 * Click anywhere else → focus cleared (the screen calls {@link #clearFocus()} before dispatching click events, so
 * panels naturally re-focus their own inputs if clicked).
 * <p>
...
public final class TextInput {
     ...
     * click landed. Called by {@link com.blib.engine.ui.EngineWorkspaceScreen} via the static
     * {@link #getDragSelecting()} pointer so drags survive the cursor leaving the input rect.
     */
