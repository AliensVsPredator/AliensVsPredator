 ...
 * fallback) without mutating {@link SelectionManager}. The {@link com.blib.engine.render.selection.EngineHoverRenderer}
 * reads {@link #current()} each frame to draw a subtle outline so users have a visual cue for click targeting.
 * <p>
