 ...
 * <p>
 * Plugged into the same debug-render injection as {@link com.blib.engine.jigsaw.JigsawPlacementWorldRenderer}. No-ops
 * fast when engine mode is off or the selection has no corners.
 */
@ApiStatus.Internal
