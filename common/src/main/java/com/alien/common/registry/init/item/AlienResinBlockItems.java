...
public class AlienResinBlockItems {
    ...
    public static final AVPDeferredHolder<BlockItem> ABERRANT_RESIN_BRICKS = AVPBlockItems.register(
        "aberrant_resin_bricks",
        AlienResinBlocks.ABERRANT_RESIN_BRICKS
    );

    public static final AVPDeferredHolder<BlockItem> ABERRANT_RESIN_BRICK_SLAB = AVPBlockItems.register(
        "aberrant_resin_brick_slab",
        AlienResinBlocks.ABERRANT_RESIN_BRICK_SLAB
    );

    public static final AVPDeferredHolder<BlockItem> ABERRANT_RESIN_BRICK_STAIRS = AVPBlockItems.register(
    ...
    public static final AVPDeferredHolder<BlockItem> IRRADIATED_RESIN_BRICKS = AVPBlockItems.register(
        "irradiated_resin_bricks",
        AlienResinBlocks.IRRADIATED_RESIN_BRICKS
    );

    public static final AVPDeferredHolder<BlockItem> IRRADIATED_RESIN_BRICK_SLAB = AVPBlockItems.register(
    ...
    public static final AVPDeferredHolder<BlockItem> NETHER_RESIN_BRICKS = AVPBlockItems.register(
        "nether_resin_bricks",
        AlienResinBlocks.NETHER_RESIN_BRICKS
    );

    public static final AVPDeferredHolder<BlockItem> NETHER_RESIN_BRICK_SLAB = AVPBlockItems.register(
        "nether_resin_brick_slab",
        AlienResinBlocks.NETHER_RESIN_BRICK_SLAB
    );

    public static final AVPDeferredHolder<BlockItem> NETHER_RESIN_BRICK_STAIRS = AVPBlockItems.register(
    ...
    public static final AVPDeferredHolder<BlockItem> ABERRANT_RESIN_VENT = AVPBlockItems.register(
        "aberrant_resin_vent",
        AlienResinBlocks.ABERRANT_RESIN_VENT
    );

    public static final AVPDeferredHolder<BlockItem> IRRADIATED_RESIN_VENT = AVPBlockItems.register(
        "irradiated_resin_vent",
        AlienResinBlocks.IRRADIATED_RESIN_VENT
    );

    public static final AVPDeferredHolder<BlockItem> NETHER_RESIN_VENT = AVPBlockItems.register(
        "nether_resin_vent",
    ...
    public static final AVPDeferredHolder<BlockItem> RIBBED_ABERRANT_RESIN = AVPBlockItems.register(
        "ribbed_aberrant_resin",
        AlienResinBlocks.RIBBED_ABERRANT_RESIN
    );

    public static final AVPDeferredHolder<BlockItem> RIBBED_IRRADIATED_RESIN = AVPBlockItems.register(
        "ribbed_irradiated_resin",
        AlienResinBlocks.RIBBED_IRRADIATED_RESIN
    );

    public static final AVPDeferredHolder<BlockItem> RIBBED_NETHER_RESIN = AVPBlockItems.register(
        "ribbed_nether_resin",
    ...
    public static final AVPDeferredHolder<BlockItem> SMOOTH_ABERRANT_RESIN = AVPBlockItems.register(
        "smooth_aberrant_resin",
        AlienResinBlocks.SMOOTH_ABERRANT_RESIN
    );

    public static final AVPDeferredHolder<BlockItem> SMOOTH_IRRADIATED_RESIN = AVPBlockItems.register(
        "smooth_irradiated_resin",
        AlienResinBlocks.SMOOTH_IRRADIATED_RESIN
    );

    public static final AVPDeferredHolder<BlockItem> SMOOTH_NETHER_RESIN = AVPBlockItems.register(
        "smooth_nether_resin",
