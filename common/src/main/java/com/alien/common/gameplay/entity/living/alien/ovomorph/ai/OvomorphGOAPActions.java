...
public class OvomorphGOAPActions {
    ...
    static final Action<Ovomorph> HATCH = Action.<Ovomorph>builder("HatchAction")
        .addPrecondition(OvomorphGOAPKeys.WANTS_TO_HATCH, Expression.isTrue())
        .addPrecondition(OvomorphGOAPKeys.HATCH_STATE, Expression.doesNotEqual(HatchState.HATCHED))
