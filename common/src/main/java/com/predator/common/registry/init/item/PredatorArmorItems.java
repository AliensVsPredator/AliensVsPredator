...
public class PredatorArmorItems {
    ...
    public static final AVPDeferredHolder<ArmorItem> JUNGLE_PREDATOR_LEGGINGS = AVPArmorItems.register(
        "jungle_predator_leggings",
        () -> new VeritaniumArmorItem(ArmorItem.Type.LEGGINGS)
    );

    public static final AVPDeferredHolder<ArmorItem> JUNGLE_PREDATOR_HELMET = AVPArmorItems.register(
        "jungle_predator_helmet",
        () -> new VeritaniumArmorItem(ArmorItem.Type.HELMET)
    );

    public static final AVPDeferredHolder<ArmorItem> JUNGLE_PREDATOR_CHESTPLATE = AVPArmorItems.register(
        "jungle_predator_chestplate",
        () -> new VeritaniumArmorItem(ArmorItem.Type.CHESTPLATE)
    );

    public static final AVPDeferredHolder<ArmorItem> JUNGLE_PREDATOR_BOOTS = AVPArmorItems.register(
