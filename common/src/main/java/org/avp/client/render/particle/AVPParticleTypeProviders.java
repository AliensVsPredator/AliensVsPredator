...
public class AVPParticleTypeProviders extends AVPDeferredRegistry<ParticleProviderData<ParticleOptions>> {
    ...
    @Override
    protected Holder<ParticleProviderData<ParticleOptions>> createHolder(String registryName, Supplier<ParticleProviderData<ParticleOptions>> supplier) {
    ...
    public void register() {
        createHolder("acid_provider", () -> new ParticleProviderData<>(
