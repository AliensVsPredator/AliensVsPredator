...
public class DerelictSchematicResolver {
    ...
    public static final Map<String, Block> RESOLVER_MAP = Map.<String, Block>ofEntries(
        ...
        Map.entry("avp:engineershipbrick1", AVPEngineerBlocks.INSTANCE.BRICK_1.get()),
        Map.entry("avp:engineershipbrick2", AVPEngineerBlocks.INSTANCE.BRICK_2.get()),
        Map.entry("avp:engineershipbrick3", AVPEngineerBlocks.INSTANCE.BRICK_3.get()),
        Map.entry("avp:engineershipcolumn1", AVPEngineerBlocks.INSTANCE.COLUMN_1.get()),
        Map.entry("avp:engineershipcolumn2", AVPEngineerBlocks.INSTANCE.COLUMN_2.get()),
        Map.entry("avp:engineershipgravel", AVPEngineerBlocks.INSTANCE.GRAVEL.get()),
        Map.entry("avp:engineershipmaterial1", AVPEngineerBlocks.INSTANCE.MATERIAL_1.get()),
        Map.entry("avp:engineershipmaterial2", AVPEngineerBlocks.INSTANCE.MATERIAL_2.get()),
        Map.entry("avp:engineershiprock2", AVPEngineerBlocks.INSTANCE.ROCK_2.get()),
        Map.entry("avp:engineershiprock3", AVPEngineerBlocks.INSTANCE.ROCK_3.get()),
        Map.entry("avp:engineershipwall1", AVPEngineerBlocks.INSTANCE.WALL_1.get()),
        Map.entry("avp:engineershipwall2", AVPEngineerBlocks.INSTANCE.WALL_2.get()),
        Map.entry("avp:engineershipwall3", AVPEngineerBlocks.INSTANCE.WALL_3.get()),
        Map.entry("avp:engineershipwall4", AVPEngineerBlocks.INSTANCE.WALL_4.get()),
