...
public class DerelictSchematicResolver {
    ...
    public static final Map<String, Block> RESOLVER_MAP = Map.<String, Block>ofEntries(
        ...
        Map.entry("avp:engineershipbrick1", AVPEngineerBlocks.INSTANCE.brick1.get()),
        Map.entry("avp:engineershipbrick2", AVPEngineerBlocks.INSTANCE.brick2.get()),
        Map.entry("avp:engineershipbrick3", AVPEngineerBlocks.INSTANCE.brick3.get()),
        ...
        Map.entry("avp:engineershipmaterial1", AVPEngineerBlocks.INSTANCE.material1.get()),
        Map.entry("avp:engineershipmaterial2", AVPEngineerBlocks.INSTANCE.material2.get()),
        ...
        Map.entry("avp:engineershipwall1", AVPEngineerBlocks.INSTANCE.wall1.get()),
