...
public class DerelictSchematicResolver {
    ...
    public static final Map<String, Block> RESOLVER_MAP = Map.<String, Block>ofEntries(
        ...
        Map.entry("avp:engineershipbrick1", AVPEngineerBlocks.BRICK_1.get()),
        Map.entry("avp:engineershipbrick2", AVPEngineerBlocks.BRICK_2.get()),
        Map.entry("avp:engineershipbrick3", AVPEngineerBlocks.BRICK_3.get()),
        Map.entry("avp:engineershipcolumn1", AVPEngineerBlocks.COLUMN_1.get()),
        Map.entry("avp:engineershipcolumn2", AVPEngineerBlocks.COLUMN_2.get()),
        Map.entry("avp:engineershipgravel", AVPEngineerBlocks.GRAVEL.get()),
        Map.entry("avp:engineershipmaterial1", AVPEngineerBlocks.MATERIAL_1.get()),
        Map.entry("avp:engineershipmaterial2", AVPEngineerBlocks.MATERIAL_2.get()),
        Map.entry("avp:engineershiprock2", AVPEngineerBlocks.ROCK_2.get()),
        Map.entry("avp:engineershiprock3", AVPEngineerBlocks.ROCK_3.get()),
        Map.entry("avp:engineershipwall1", AVPEngineerBlocks.WALL_1.get()),
        Map.entry("avp:engineershipwall2", AVPEngineerBlocks.WALL_2.get()),
        Map.entry("avp:engineershipwall3", AVPEngineerBlocks.WALL_3.get()),
        Map.entry("avp:engineershipwall4", AVPEngineerBlocks.WALL_4.get()),
