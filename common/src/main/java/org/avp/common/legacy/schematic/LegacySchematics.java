...
public final class LegacySchematics {
    ...
    public static final GameObject<LegacySchematic> LV_426_SPIKE_01_SCHEMATIC = loadLVSpike("lv_426_spike_01", LV_426_SPIKE_01_PATH);

    public static final GameObject<LegacySchematic> LV_426_SPIKE_02_SCHEMATIC = loadLVSpike("lv_426_spike_02", LV_426_SPIKE_02_PATH);

    public static final GameObject<LegacySchematic> LV_426_SPIKE_03_SCHEMATIC = loadLVSpike("lv_426_spike_03", LV_426_SPIKE_03_PATH);

    public static final GameObject<LegacySchematic> LV_426_SPIKE_04_SCHEMATIC = loadLVSpike("lv_426_spike_04", LV_426_SPIKE_04_PATH);

    public static final GameObject<LegacySchematic> LV_426_SPIKE_05_SCHEMATIC = loadLVSpike("lv_426_spike_05", LV_426_SPIKE_05_PATH);

    public static final GameObject<LegacySchematic> LV_426_SPIKE_06_SCHEMATIC = loadLVSpike("lv_426_spike_06", LV_426_SPIKE_06_PATH);
    ...
    private static GameObject<LegacySchematic> loadLVSpike(String name, Path path) {
