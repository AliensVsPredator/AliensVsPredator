...
public final class LegacySchematics {
    ...
    public static final BLHolder<LegacySchematic> DERELICT_OLD_SCHEMATIC = new AVPHolder<>(
        "derelict_old",
        () -> LegacySchematicLoader.loadFromFile(DERELICT_OLD_PATH.toFile(), Map.of()).orElse(null)
    );

    public static final AVPHolder<LegacySchematic> DERELICT_SCHEMATIC = new AVPHolder<>(
        "derelict",
        () -> LegacySchematicLoader.loadFromFile(DERELICT_PATH.toFile(), DerelictSchematicResolver.RESOLVER_MAP)
            .orElse(null)
    );

    public static final BLHolder<LegacySchematic> LV_426_SPIKE_01_SCHEMATIC = loadLVSpike("lv_426_spike_01", LV_426_SPIKE_01_PATH);

    public static final BLHolder<LegacySchematic> LV_426_SPIKE_02_SCHEMATIC = loadLVSpike("lv_426_spike_02", LV_426_SPIKE_02_PATH);

    public static final BLHolder<LegacySchematic> LV_426_SPIKE_03_SCHEMATIC = loadLVSpike("lv_426_spike_03", LV_426_SPIKE_03_PATH);

    public static final BLHolder<LegacySchematic> LV_426_SPIKE_04_SCHEMATIC = loadLVSpike("lv_426_spike_04", LV_426_SPIKE_04_PATH);

    public static final BLHolder<LegacySchematic> LV_426_SPIKE_05_SCHEMATIC = loadLVSpike("lv_426_spike_05", LV_426_SPIKE_05_PATH);

    public static final BLHolder<LegacySchematic> LV_426_SPIKE_06_SCHEMATIC = loadLVSpike("lv_426_spike_06", LV_426_SPIKE_06_PATH);

    public static final AVPHolder<LegacySchematic> TEST_SCHEMATIC = new AVPHolder<>(
        "test",
        () -> LegacySchematicLoader.loadFromFile(TEST_PATH.toFile(), TestSchematicResolver.RESOLVER_MAP).orElse(null)
    );

    private static AVPHolder<LegacySchematic> loadLVSpike(String name, Path path) {
