...
public class AVPArmorItems extends AVPDeferredItemRegistry {
    ...
    public final Holder<Item> veritaniumLeggings = createHolder("veritanium_leggings", AVPArmorMaterials.VERITANIUM, ArmorItem.Type.LEGGINGS);

    public final Holder<Item> xenomorphBody = createHolder("xenomorph_chitin_body", AVPArmorMaterials.XENOMORPH_CHITIN, ArmorItem.Type.CHESTPLATE);
    public final Holder<Item> xenomorphBoots = createHolder("xenomorph_chitin_boots", AVPArmorMaterials.XENOMORPH_CHITIN, ArmorItem.Type.BOOTS);
    public final Holder<Item> xenomorphHelmet = createHolder("xenomorph_chitin_helmet", AVPArmorMaterials.XENOMORPH_CHITIN, ArmorItem.Type.HELMET);
    public final Holder<Item> xenomorphLeggings = createHolder("xenomorph_chitin_leggings", AVPArmorMaterials.XENOMORPH_CHITIN, ArmorItem.Type.LEGGINGS);
