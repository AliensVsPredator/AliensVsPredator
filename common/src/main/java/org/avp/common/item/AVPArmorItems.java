...
public class AVPArmorItems {
    ...
    public static final GameObject<Item> ORIONITE_BODY;

    public static final GameObject<Item> ORIONITE_BOOTS;

    public static final GameObject<Item> ORIONITE_HELMET;

    public static final GameObject<Item> ORIONITE_LEGGINGS;
    ...
    static {
        var aluminumMaterial = AVPArmorMaterials.ALUMINUM;
        ...
        var orioniteMaterial = AVPArmorMaterials.ORIONITE;
        ORIONITE_BODY = register("orionite_body", orioniteMaterial, ArmorItem.Type.CHESTPLATE);
        ORIONITE_BOOTS = register("orionite_boots", orioniteMaterial, ArmorItem.Type.BOOTS);
        ORIONITE_HELMET = register("orionite_helmet", orioniteMaterial, ArmorItem.Type.HELMET);
        ORIONITE_LEGGINGS = register("orionite_leggings", orioniteMaterial, ArmorItem.Type.LEGGINGS);

        var pressureMaterial = AVPArmorMaterials.PRESSURE;
        ...
        var tacticalMaterial = AVPArmorMaterials.TACTICAL;
