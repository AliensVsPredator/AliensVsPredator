...
public class AVPToolItems {
    ...
    static {
        ...
        ALUMINUM_PICKAXE = register("aluminum_pickaxe", () -> new ModdedPickaxeItem(AVPToolTiers.ALUMINUM, 1, -2.8F, new Item.Properties()));
        ...
        ORIONITE_PICKAXE = register("orionite_pickaxe", () -> new ModdedPickaxeItem(AVPToolTiers.ORIONITE, 1, -2.8F, new Item.Properties()));
        ...
        TITANIUM_PICKAXE = register("titanium_pickaxe", () -> new ModdedPickaxeItem(AVPToolTiers.TITANIUM, 1, -2.8F, new Item.Properties()));
        ...
        VERITANIUM_PICKAXE = register("veritanium_pickaxe", () -> new ModdedPickaxeItem(AVPToolTiers.VERITANIUM, 1, -2.8F, new Item.Properties()));
        VERITANIUM_SHOVEL = register("veritanium_shovel", () -> new ShovelItem(AVPToolTiers.VERITANIUM, 1.5F, -3.0F, new Item.Properties()));
