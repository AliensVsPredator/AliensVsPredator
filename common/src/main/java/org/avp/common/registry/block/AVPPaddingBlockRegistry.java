...
public class AVPPaddingBlockRegistry extends AVPDeferredBlockRegistry {

    public static final AVPPaddingBlockRegistry INSTANCE = new AVPPaddingBlockRegistry();
    ...
    private AVPPaddingBlockRegistry() {
    ...
    public record PaddingBlockSet(
        Item dyeItem,
        BLHolder<Block> panel,
        BLHolder<Block> pipes,
