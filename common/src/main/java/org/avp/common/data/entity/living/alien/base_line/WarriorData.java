...
public class WarriorData extends EntityData<Warrior> {
    ...
    @Override
    protected BLHolder<EntityType<Warrior>> createHolder() {
    ...
    protected Optional<EntitySoundData> createSoundData() {
        return Optional.of(
            new EntitySoundData(
                AVPSoundEventRegistry.INSTANCE.entityWarrior.ambient(),
                AlienSounds.createSoundEventSelector(AVPSoundEventRegistry.INSTANCE.entityWarrior.hurt()),
                AVPSoundEventRegistry.INSTANCE.entityWarrior.death()
            )
        );
    }
    ...
    protected Optional<EntitySpawnData<?>> createSpawnData() {
        return Optional.of(
            new EntitySpawnData<>(
                ...
                ($, accessor, spawnType, pos, randSrc) -> pos.getY() <= AVPConfig.Aliens.MAX_Y_LEVEL_FOR_WARRIOR_SPAWNS &&
