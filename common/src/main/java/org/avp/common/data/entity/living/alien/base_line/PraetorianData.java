...
public class PraetorianData extends EntityData<Praetorian> {
    ...
    @Override
    protected BLHolder<EntityType<Praetorian>> createHolder() {
    ...
    protected Optional<EntitySoundData> createSoundData() {
        return Optional.of(
            new EntitySoundData(
                AVPSoundEventRegistry.INSTANCE.entityPraetorian.ambient(),
                AlienSounds.createSoundEventSelector(AVPSoundEventRegistry.INSTANCE.entityPraetorian.hurt()),
                AVPSoundEventRegistry.INSTANCE.entityPraetorian.death()
            )
        );
    }
