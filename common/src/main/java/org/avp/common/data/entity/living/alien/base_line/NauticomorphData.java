...
public class NauticomorphData extends EntityData<Nauticomorph> {
    ...
    @Override
    protected BLHolder<EntityType<Nauticomorph>> createHolder() {
    ...
    protected Optional<EntitySoundData> createSoundData() {
        return Optional.of(
            new EntitySoundData(
                AVPSoundEventRegistry.INSTANCE.entityNauticomorph.ambient(),
                AlienSounds.createSoundEventSelector(AVPSoundEventRegistry.INSTANCE.entityNauticomorph.hurt()),
                AVPSoundEventRegistry.INSTANCE.entityNauticomorph.death()
            )
        );
    }
