...
public class ChestbursterData extends EntityData<Chestburster> {
    ...
    @Override
    protected BLHolder<EntityType<Chestburster>> createHolder() {
    ...
    protected Optional<EntitySoundData> createSoundData() {
        return Optional.of(
            new EntitySoundData(
                BLHolder.empty(),
                $ -> AVPSoundEventRegistry.INSTANCE.entityChestburster.hurt(),
                AVPSoundEventRegistry.INSTANCE.entityChestburster.death()
            )
        );
    }
