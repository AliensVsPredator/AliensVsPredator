...
public class ChestbursterDracoData extends EntityData<ChestbursterDraco> {
    ...
    @Override
    protected BLHolder<EntityType<ChestbursterDraco>> createHolder() {
    ...
    protected Optional<EntitySoundData> createSoundData() {
        return Optional.of(
            new EntitySoundData(
                BLHolder.empty(),
                $ -> AVPSoundEventRegistry.INSTANCE.entityChestbursterDraco.hurt(),
                AVPSoundEventRegistry.INSTANCE.entityChestbursterDraco.death()
            )
        );
    }
