...
public class MetalIronBlockSetDataContainer extends ExtendedBlockDataContainer implements RecipeCreator {

    public static final MetalIronBlockSetDataContainer INSTANCE = new MetalIronBlockSetDataContainer();
    ...
    protected MetalIronBlockSetDataContainer() {
        ...
        // Plated
        this.plated = this.addVariant(base.extend("iron_plated"));
        ...
        // Plated Chevron
        this.platedChevron = this.addVariant(base.extend("iron_plated_chevron"));
        ...
        // Plated Stack
        this.platedStack = this.addVariant(base.extend("iron_plated_stack"));
        ...
        this.vent = this.addVariant(base.extend("iron_vent"));
    }
    ...
    public void createRecipes(RecipeOutput recipeOutput) {
        ...
        var stonecutBase = builder.stonecut(Blocks.IRON_BLOCK)
