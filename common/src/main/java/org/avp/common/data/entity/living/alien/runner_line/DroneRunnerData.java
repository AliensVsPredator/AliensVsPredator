...
public class DroneRunnerData extends EntityData<DroneRunner> {
    ...
    @Override
    protected BLHolder<EntityType<DroneRunner>> createHolder() {
    ...
    protected Optional<EntitySoundData> createSoundData() {
        return Optional.of(
            new EntitySoundData(
                AVPSoundEventRegistry.INSTANCE.entityDroneRunner.ambient(),
                AlienSounds.createSoundEventSelector(AVPSoundEventRegistry.INSTANCE.entityDroneRunner.hurt()),
                AVPSoundEventRegistry.INSTANCE.entityDroneRunner.death()
            )
        );
    }
    ...
    protected Optional<EntitySpawnData<?>> createSpawnData() {
        return Optional.of(
            new EntitySpawnData<>(
                ...
                ($, accessor, spawnType, pos, randSrc) -> pos.getY() <= AVPConfig.Aliens.MAX_Y_LEVEL_FOR_DRONE_RUNNER_SPAWNS &&
