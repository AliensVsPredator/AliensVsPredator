...
public class MetalNetheriteBlockSetDataContainer extends ExtendedBlockDataContainer {
    ...
    private static final BlockBehaviour.Properties PROPERTIES = BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERITE_BLOCK);
    ...
    protected MetalNetheriteBlockSetDataContainer() {
        ...
        this.grate = this.addVariant(
            base.transform("netherite_grate")
        ...
        // Plated
        this.plated = this.addVariant(base.extend("netherite_plated"));
        ...
        // Plated Chevron
        this.platedChevron = this.addVariant(base.extend("netherite_plated_chevron"));
        ...
        // Plated Stack
        this.platedStack = this.addVariant(base.extend("netherite_plated_stack"));
        ...
        this.vent = this.addVariant(base.extend("netherite_vent"));
    }
    ...
    public void createRecipes(RecipeOutput recipeOutput) {
        ...
        var stonecutBase = builder.stonecut(Blocks.NETHERITE_BLOCK)
