...
public class ChestbursterQueenData extends EntityData<ChestbursterQueen> {
    ...
    @Override
    protected Holder<EntityType<ChestbursterQueen>> createHolder() {
    ...
    protected Optional<EntitySoundData> createSoundData() {
        return Optional.of(
            new EntitySoundData(
                Holder.empty(),
                $ -> AVPSoundEvents.INSTANCE.entityChestbursterQueen.hurt(),
                AVPSoundEvents.INSTANCE.entityChestbursterQueen.death()
            )
        );
    }
