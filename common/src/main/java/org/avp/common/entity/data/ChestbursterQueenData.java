...
public class ChestbursterQueenData extends EntityData<ChestbursterQueen> {
    ...
    private static final Holder<EntityType<ChestbursterQueen>> HOLDER = AVPSimpleDeferredEntityTypeRegistry.INSTANCE.createMobHolder(
        "chestburster_queen",
        0xD8B877,
        0xF7E2B4,
    ...
    @Override
    public Holder<EntityType<ChestbursterQueen>> getHolder() {
        return HOLDER;
    }
