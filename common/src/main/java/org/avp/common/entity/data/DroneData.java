...
public class DroneData extends EntityData<Drone> {
    ...
    private static final Holder<EntityType<Drone>> HOLDER = AVPSimpleDeferredEntityTypeRegistry.INSTANCE.createMobHolder(
        "drone",
        0x010202,
        0xDFE2E4,
    ...
    @Override
    public Holder<EntityType<Drone>> getHolder() {
        return HOLDER;
    }
