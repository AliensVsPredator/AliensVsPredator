...
public class ChestbursterData extends EntityData<Chestburster> {
    ...
    private static final Holder<EntityType<Chestburster>> HOLDER = AVPSimpleDeferredEntityTypeRegistry.INSTANCE.createMobHolder(
        "chestburster",
        0xD8B877,
        0xF7E2B4,
    ...
    @Override
    public Holder<EntityType<Chestburster>> getHolder() {
        return HOLDER;
    }
