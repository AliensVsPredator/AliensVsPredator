...
public class WarriorRunnerData extends EntityData<WarriorRunner> {
    ...
    private static final Holder<EntityType<WarriorRunner>> HOLDER = AVPSimpleDeferredEntityTypeRegistry.INSTANCE.createMobHolder(
        "warrior_runner",
        0x1A1917,
        0x61615E,
    ...
    @Override
    public Holder<EntityType<WarriorRunner>> getHolder() {
        return HOLDER;
    }
