...
public class Praetorian extends Monster implements GeoEntity {
    ...
    protected SoundEvent getAmbientSound() {
        return AVPSoundEvents.INSTANCE.ENTITY_PRAETORIAN_AMBIENT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return AVPSoundEvents.INSTANCE.ENTITY_PRAETORIAN_DEATH.get();
    }

    @Override
    protected SoundEvent getHurtSound(@NotNull DamageSource damageSource) {
        return AVPSoundEvents.INSTANCE.ENTITY_PRAETORIAN_HURT.get();
    }
