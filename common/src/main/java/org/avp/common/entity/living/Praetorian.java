...
public class Praetorian extends Monster implements Morphable, GeoEntity {
    ...
    public EntityType<?> getEntityTypeForPreviousForm() {
        // TODO: Praes might also come from queen bursters, maybe randomize here or use entity's NBT?
        return WarriorData.INSTANCE.getHolder().get();
    }
}
