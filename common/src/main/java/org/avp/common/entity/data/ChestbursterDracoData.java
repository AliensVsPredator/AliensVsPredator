...
public class ChestbursterDracoData extends EntityData<ChestbursterDraco> {
    ...
    private static final Holder<EntityType<ChestbursterDraco>> HOLDER = AVPSimpleDeferredEntityTypeRegistry.INSTANCE.createMobHolder(
        "chestburster_draco",
        0xD8B877,
        0xF7E2B4,
    ...
    @Override
    public Holder<EntityType<ChestbursterDraco>> getHolder() {
        return HOLDER;
    }
