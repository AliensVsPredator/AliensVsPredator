...
public class BelugabursterData extends EntityData<Belugaburster> {
    ...
    private static final Holder<EntityType<Belugaburster>> HOLDER = AVPSimpleDeferredEntityTypeRegistry.INSTANCE.createMobHolder(
        "belugaburster",
        0xC2C1BD,
        0x646857,
    ...
    @Override
    public Holder<EntityType<Belugaburster>> getHolder() {
        return HOLDER;
    }
