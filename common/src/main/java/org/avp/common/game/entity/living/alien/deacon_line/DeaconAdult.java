...
public class DeaconAdult extends Monster implements Morphable, GeoEntity {

    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public DeaconAdult(EntityType<? extends Monster> entityType, Level level) {
    ...
    public EntityType<?> getEntityTypeForPreviousForm() {
        return DeaconData.INSTANCE.getHolder().get();
    }
}
