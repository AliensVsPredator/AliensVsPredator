...
public class MixinEntityTypeBuilder_SilenceDataFixerError implements SilencedEntityTypeBuilder {
    ...
    public <T extends Entity> EntityType<T> buildWithoutDataFixerCheck() {
        return new EntityType<>((EntityType.EntityFactory<T>) this.factory, this.category, this.serialize, this.summon, this.fireImmune, this.canSpawnFarFromPlayer, this.immuneTo, this.dimensions, this.clientTrackingRange, this.updateInterval, this.requiredFeatures);
    }
}
