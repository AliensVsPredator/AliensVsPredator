...
public class AVPProfessions {
    ...
    public static final Holder<PoiType> COMMISSARY_POI = POI_TYPES.register("commissary_poi",
            () -> new PoiType(ImmutableSet.copyOf(AVPBlocks.BLUEPRINT_BLOCK.get().getStateDefinition().getPossibleStates()), 1, 1));

    public static final Holder<VillagerProfession> COMMISSARY = VILLAGER_PROFESSIONS.register("commissary",
            () -> new VillagerProfession("commissary", holder -> holder.value() == COMMISSARY_POI.value(),
                    poiTypeHolder -> poiTypeHolder.value() == COMMISSARY_POI.value(), ImmutableSet.of(), ImmutableSet.of(),
