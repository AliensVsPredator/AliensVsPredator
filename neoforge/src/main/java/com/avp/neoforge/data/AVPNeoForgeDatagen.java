...
public class AVPNeoForgeDatagen {
    ...
    private static final List<AVPSpawnData> spawnDataList = List.of(
            ...
            new AVPSpawnData(EntityType.BEE, AVPEntitySpawnKeys.ADD_SPAWNS_NETHER_CHESTBURSTER, BiomeTags.IS_NETHER, config.NETHER_CHESTBURSTER_SPAWN),
            ...
            new AVPSpawnData(EntityType.CAMEL, AVPEntitySpawnKeys.ADD_SPAWNS_NETHER_PRAETORIAN, BiomeTags.IS_NETHER, config.NETHER_PRAETORIAN_SPAWN),
            ...
            (DataProvider.Factory<DatapackBuiltinEntriesProvider>) output -> new DatapackBuiltinEntriesProvider(
                ...
                new RegistrySetBuilder()
                    .add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, bootstrap -> {
                        ...
                        bootstrap.register(AVPFeatureKeys.ADD_BAUXITE_MIDDLE, new BiomeModifiers.AddFeaturesBiomeModifier(
                            bootstrap.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
                            HolderSet.direct(placedFeatures.getOrThrow(AVPOres.BAUXITE_MIDDLE.placedFeatureKey())),
                            GenerationStep.Decoration.UNDERGROUND_ORES));
                        bootstrap.register(AVPFeatureKeys.ADD_BAUXITE_UPPER, new BiomeModifiers.AddFeaturesBiomeModifier(
                            bootstrap.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
                            HolderSet.direct(placedFeatures.getOrThrow(AVPOres.BAUXITE_UPPER.placedFeatureKey())),
                            GenerationStep.Decoration.UNDERGROUND_ORES));
                        bootstrap.register(AVPFeatureKeys.ADD_GALENA, new BiomeModifiers.AddFeaturesBiomeModifier(
                            bootstrap.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
                            HolderSet.direct(placedFeatures.getOrThrow(AVPOres.GALENA.placedFeatureKey())),
                            GenerationStep.Decoration.UNDERGROUND_ORES));
                        bootstrap.register(AVPFeatureKeys.ADD_LITHIUM, new BiomeModifiers.AddFeaturesBiomeModifier(
                            bootstrap.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
                            HolderSet.direct(placedFeatures.getOrThrow(AVPOres.LITHIUM.placedFeatureKey())),
                            GenerationStep.Decoration.UNDERGROUND_ORES));
                        bootstrap.register(AVPFeatureKeys.ADD_MONAZITE, new BiomeModifiers.AddFeaturesBiomeModifier(
                            bootstrap.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
                            HolderSet.direct(placedFeatures.getOrThrow(AVPOres.MONAZITE.placedFeatureKey())),
                            GenerationStep.Decoration.UNDERGROUND_ORES));
                        bootstrap.register(AVPFeatureKeys.ADD_SILICON_GRAVEL, new BiomeModifiers.AddFeaturesBiomeModifier(
                            bootstrap.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
                            HolderSet.direct(placedFeatures.getOrThrow(AVPOres.SILICON_GRAVEL.placedFeatureKey())),
                            GenerationStep.Decoration.UNDERGROUND_ORES));
                        bootstrap.register(AVPFeatureKeys.ADD_TITANIUM_LOWER, new BiomeModifiers.AddFeaturesBiomeModifier(
                            bootstrap.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
                            HolderSet.direct(placedFeatures.getOrThrow(AVPOres.TITANIUM_LOWER.placedFeatureKey())),
                            GenerationStep.Decoration.UNDERGROUND_ORES));

                        bootstrap.register(AVPFeatureKeys.ADD_LEAD_SWAMP, new BiomeModifiers.AddFeaturesBiomeModifier(
                            HolderSet.direct(
                        ...
                        bootstrap.register(AVPFeatureKeys.ADD_LITHIUM_DESERT, new BiomeModifiers.AddFeaturesBiomeModifier(
                            HolderSet.direct(
                        ...
                        bootstrap.register(AVPFeatureKeys.ADD_MONAZITE_JUNGLE, new BiomeModifiers.AddFeaturesBiomeModifier(
