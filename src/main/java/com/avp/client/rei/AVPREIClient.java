...
public class AVPREIClient implements REIClientPlugin {
    ...
    public void registerDisplays(DisplayRegistry registry) {
        registry.registerRecipeFiller(IndustrialFurnaceRecipe.class, AVPRecipes.INDUSTRIAL_FURNACE_RECIPE_TYPE,
    ...
    public void registerScreens(ScreenRegistry registry) {
        registry.registerClickArea(screen -> new Rectangle(((screen.width - 176) / 2) + 78,
                        ((screen.height - 166) / 2) + 30, 20, 25), IndustrialFurnaceScreen.class,
