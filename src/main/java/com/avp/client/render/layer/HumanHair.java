...
public class HumanHair implements AzRenderLayer<MarineMob> {
    ...
    public void render(AzRendererPipelineContext<MarineMob> context) {
        ...
        var textureMaleLocation = AVPResources.entityTextureLocation("marine_male_hair");
        var textureFemaleLocation = AVPResources.entityTextureLocation("marine_female_hair");
