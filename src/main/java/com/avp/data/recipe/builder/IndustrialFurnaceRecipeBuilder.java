...
public class IndustrialFurnaceRecipeBuilder implements RecipeBuilder {
    ...
    private IndustrialFurnaceRecipeBuilder(RecipeCategory recipeCategory, CookingBookCategory cookingBookCategory, ItemLike itemLike, Ingredient ingredient, float experience, int cookingTime) {
    ...
    public static IndustrialFurnaceRecipeBuilder smelting(Ingredient ingredient, RecipeCategory recipeCategory, ItemLike itemLike, float experience, int cookingTime) {
        return new IndustrialFurnaceRecipeBuilder(recipeCategory, determineSmeltingRecipeCategory(itemLike), itemLike, ingredient, experience, cookingTime);
    }
