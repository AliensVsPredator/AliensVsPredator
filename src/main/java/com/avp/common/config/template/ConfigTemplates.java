...
public class ConfigTemplates {
    ...
    public static final ConfigTemplate SPAWNING = ConfigTemplateBuilder.create()
        ...
        .newLine()
        .comment("The maximum spawn count for predator within the custom alien mob category. Modifying this requires restarting the game.")
        .comment("Changing this value will only work if the custom mob category for aliens is enabled.")
        .property(ConfigProperties.PREDATOR_CUSTOM_MOB_CATEGORY_SPAWN_LIMIT)
        .newLine()
        ...
        .newLine()
        .comment("Nether Queen spawn values. Modifying any of these will require restarting the game.")
        .properties(ConfigProperties.NETHER_QUEEN_SPAWNING)
        .newLine()
