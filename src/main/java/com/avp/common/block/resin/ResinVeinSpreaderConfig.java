...
class ResinVeinSpreaderConfig extends MultifaceSpreader.DefaultSpreaderConfig {
    ...
    public boolean stateCanBeReplaced(
        ...
        var isNotResinNode = !blockState2.is(AVPBlocks.IRRADIATED_RESIN_NODE) && !blockState2.is(AVPBlocks.ABERRANT_RESIN_NODE) && !blockState2.is(AVPBlocks.NETHER_RESIN_NODE) && !blockState2.is(AVPBlocks.RESIN_NODE);
