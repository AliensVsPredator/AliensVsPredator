...
public class BlocksCreativeModeTabInitializer {
    ...
    public static void initialize() {
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.BLOCKS_KEY).register(entries -> {
            ...
            entries.accept(AVPBlocks.FERROALUMINUM_BUTTON);
            ...
            entries.accept(AVPBlocks.STEEL_BUTTON);
            ...
            entries.accept(AVPBlocks.TITANIUM_BUTTON);
            ...
            entries.accept(AVPBlocks.ABERRANT_RESIN);
            entries.accept(AVPBlocks.ABERRANT_RESIN_VEIN);
            entries.accept(AVPBlocks.ABERRANT_RESIN_WEB);
            entries.accept(AVPBlocks.IRRADIATED_RESIN);
